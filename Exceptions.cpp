...
// OutOfBoundsEx
    ...
    std::ostream &OutOfBoundsEx::operator<<(std::ostream &os, const OutOfBoundsEx &ex)
    {
...
//DimensionalityMismatchEx
    ...
    std::ostream &DimensionalityMismatchEx::operator<<(std::ostream &os, const DimensionalityMismatchEx &ex)
    {
...
//ZeroClustersEx
    ...
    std::ostream &ZeroClustersEx::operator<<(std::ostream &os, const ZeroClustersEx &ex)
    {
...
//DataFileOpenEx
    ...
    std::ostream &DataFileOpenEx::operator<<(std::ostream &os, const DataFileOpenEx &ex)
    {
...
//ZeroDimensionsEx
    ...
    std::ostream &ZeroDimensionsEx::operator<<(std::ostream &os, const ZeroDimensionsEx &ex)
    {
...
//EmptyClusterEx
    ...
    std::ostream &EmptyClusterEx::operator<<(std::ostream &os, const EmptyClusterEx &ex)
    {
